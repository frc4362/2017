...
public class BlueBoilerSideGearAuton extends CommandGroup {
    ...
    public BlueBoilerSideGearAuton(final Alliance alliance) {
	    	...
	    	addSequential(new DriveDistance(Hardware.getInstance().getDrive(), 43 * -alliance.getMultiplier(), 0.4 * -alliance.getMultiplier()));
